class Game {
    constructor() {
        ...
        this.scoreGame = document.querySelector('.score-game');
        this.tickScoreGame = null;
    }
    ...
    start() {
        if (this.status.isPaused()) {
            ...
            this.tickScoreGame = setInterval(this.gameScoreDisplayed.bind(this),1000 / this.settings.speed);
        }
    }
    ...
    pause() {
        if (this.status.isPlaying()) {
            ...
            clearInterval(this.tickScoreGame);
        }
    }
     ...
     */
    gameScoreDisplayed(){
        this.scoreGame.textContent = `Ваш счет : ${this.snake.body.length}`;
       }
}